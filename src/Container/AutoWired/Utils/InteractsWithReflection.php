...
namespace RahimiAli\Hermes\Container\AutoWired\Utils;
...
trait InteractsWithReflection
{
     ...
     * @return string[]
     */
    protected static function extendInterface(ReflectionClass $reflectionClass): array
    {
        ...
        return [
            ...
            ...array_values(
                array_map(
                    static fn (ReflectionClass $reflectionClass) => $reflectionClass->getName(),
                    array_filter(
                        $reflectionClass->getInterfaces(),
                        static fn (ReflectionClass $interface) => !$interface->isInternal(),
                    )
                )
            ),
        ];
